            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="content">
                        ...
                        <p>Car repair quisque sodales dui ut varius vestibulum drana tortor turpis porttiton tellus eu
                            euismod nisl massa nutodio in the miss volume place urna lacinia eros nunta urna mauris vehicula
                            rutrum in the miss on volume interdum.</p>
                        <p class="mb-30">Lorem ipsum potenti fringilla pretium ipsum non blandit vivamus eget nisi non mi
                            iaculis iaculis imperie quiseros sevin elentesque habitant farmen.</p>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{ asset('assets/img/team/1.jpg') }}" alt="">
                                    </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                            class="w-11 h-11">
                        ...
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{ asset('assets/img/team/4.jpg') }}" alt="">
                                    </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                            class="w-11 h-11">
                        ...
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{ asset('assets/img/team/6.jpg') }}" alt="">
                                    </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                            class="w-11 h-11">
    ...
    <section class="team section-padding">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="{{ asset('assets/img/team/1.jpg') }}" class="img-fluid"
                                alt="">
                        ...
                        <div class="item"> <img src="{{ asset('assets/img/team/4.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="info">
                                <div class="butn icon-bg">
                        ...
                        <div class="item"> <img src="{{ asset('assets/img/team/5.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="info">
                                <div class="butn icon-bg">
                        ...
                        <div class="item"> <img src="{{ asset('assets/img/team/2.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="butn icon-bg">
                                <a href="team-single.html" class="vid">
                        ...
                        <div class="item"> <img src="{{ asset('assets/img/team/6.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="butn icon-bg">
                                <a href="team-single.html" class="vid">
                        ...
                        <div class="item"> <img src="{{ asset('assets/img/team/3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="bottom-fade"></div>
                            <div class="butn icon-bg">
                                <a href="team-single.html" class="vid">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="clients-logo">
                            <a href="#0"><img src="{{ asset('img/clients/1.png') }}" alt=""></a>
                        </div>
                        <div class="clients-logo">
