...
@section('content')
    ...
    <header class="header slider-fade">
        <div class="owl-carousel owl-theme">
            ...
            <div class="item bg-img" data-overlay-dark="5" data-background="{{asset('assets/img/slider/11.jpg')}}">
            ...
            <div class="item bg-img" data-overlay-dark="5" data-background="{{asset('assets/img/slider/12.jpg')}}">
                <div class="v-middle caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 mb-30">
            ...
            <div class="item bg-img" data-overlay-dark="5" data-background="{{asset('assets/img/slider/14.jpg')}}">
                <div class="v-middle caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 mb-30">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1 col-md-12">
                    <div class="item"> <img src="{{asset('assets/img/about.jpg')}}" class="img-fluid" alt="">
    ...
    <section class="services2 section-padding">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                <div class="owl-carousel owl-theme">
                    <div class="item"> <img src="{{asset('assets/img/services/1.jpg')}}" class="img-fluid" alt="">
                    ...
                    <div class="item"> <img src="{{asset('assets/img/services/2.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                    ...
                    <div class="item"> <img src="{{asset('assets/img/services/3.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                    ...
                    <div class="item"> <img src="{{asset('assets/img/services/4.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                    ...
                    <div class="item"> <img src="{{asset('assets/img/services/5.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                    ...
                    <div class="item"> <img src="{{asset('assets/img/services/6.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
    ...
    <section class="car-types1 section-padding">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="{{asset('assets/img/cars/03.jpg')}}" class="img-fluid" alt="">
                            <div class="title">
                                <h4>Luxury Cars</h4>
                            </div>
                            <div class="curv-butn icon-bg">
                        ...
                        <div class="item"> <img src="{{asset('assets/img/cars/04.jpg')}}" class="img-fluid" alt="">
                            <div class="title">
                                <h4>Sport Cars</h4>
                            </div>
                            <div class="curv-butn icon-bg">
                        ...
                        <div class="item"> <img src="{{asset('assets/img/cars/02.jpg')}}" class="img-fluid" alt="">
                            <div class="title">
                                <h4>SUV</h4>
                            </div>
                            <div class="curv-butn icon-bg">
                        ...
                        <div class="item"> <img src="{{asset('assets/img/cars/01.jpg')}}" class="img-fluid" alt="">
                            <div class="title">
                                <h4>Convertible</h4>
                            </div>
                            <div class="curv-butn icon-bg">
                        ...
                        <div class="item"> <img src="{{asset('assets/img/cars/05.jpg')}}" class="img-fluid" alt="">
                            <div class="title">
                                <h4>Sedan</h4>
                            </div>
                            <div class="curv-butn icon-bg">
                        ...
                        <div class="item"> <img src="{{asset('assets/img/cars/06.jpg')}}" class="img-fluid" alt="">
                            <div class="title">
                                <h4>Small Cars</h4>
                            </div>
                            <div class="curv-butn icon-bg">
    ...
    <!-- Video -->
    <section class="video-wrapper video section-padding bg-img bg-fixed" data-overlay-dark="4" data-background="{{asset('assets/img/slider/1.jpg')}}">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{asset('assets/img/team/1.jpg')}}" alt=""> </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                            <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#ffffff"></path>
                                        </svg>
                        ...
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{asset('assets/img/team/4.jpg')}}" alt=""> </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                            <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#ffffff"></path>
                                        </svg>
                        ...
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="{{asset('assets/img/team/6.jpg')}}" alt=""> </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                            <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#ffffff"></path>
                                        </svg>
    ...
    <section class="blog2 section-padding">
        <div class="container">
            ...
            <div class="row">
                    <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="{{asset('assets/img/blog/3.jpg')}}" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6>Rental</h6>
                        ...
                        <div class="item"> <img src="{{asset('assets/img/blog/4.jpg')}}" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6>Sport Cars</h6>
                        ...
                        <div class="item"> <img src="{{asset('assets/img/blog/5.jpg')}}" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6>Fines</h6>
                        ...
                        <div class="item"> <img src="{{asset('assets/img/blog/6.jpg')}}" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6>Airport</h6>
                        ...
                        <div class="item"> <img src="{{asset('assets/img/blog/7.jpg')}}" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6>Rules</h6>
                        ...
                        <div class="item"> <img src="{{asset('assets/img/blog/8.jpg')}}" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6>Rental Car</h6>
